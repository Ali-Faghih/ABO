...
| # | Username (National ID) | Name         | Blood | City    | Eligible | Donations |
| - | ---------------------- | ------------ | ----- | ------- | -------- | --------- |
| 1 | `1532620591`           | علی محمدی    | O+    | تهران   | ✗ (locked until ۲۷ شهریور ۱۴۰۵) | 1 |
| 2 | `2529591868`           | محمد حسینی   | A+    | تهران   | ✓        | 0         |
| 3 | `2125563137`           | امیر رضایی   | B-    | تهران   | ✓        | 0         |
| 4 | `1524534405`           | حسن احمدی    | B+    | تهران   | ✓        | 0         |
| 5 | `2125635676`           | فاطمه رضایی  | A-    | تهران   | ✓        | 0         |
| 6 | `1624566949`           | زهرا احمدی   | AB+   | تهران   | ✓        | 0         |
| 7 | `2931858212`           | مریم کریمی   | O-    | تهران   | ✗        | 0         |
| 8 | `2031789484`           | نرگس موسوی   | O+    | تهران   | ✓        | 0         |

### 🏥 Hospitals

| # | Username    | Name                    | City   |
| - | ----------- | ----------------------- | ------ |
| 1 | `TEH-2A97`  | بیمارستان امام خمینی    | تهران  |
| 2 | `TEH-B3E0`  | بیمارستان شریعتی        | تهران  |
| 3 | `TEH-ED0C`  | بیمارستان سینا          | تهران  |
| 4 | `TEH-33CA`  | بیمارستان رسول اکرم     | تهران  |
| 5 | `TEH-F888`  | بیمارستان فیروزگر       | تهران  |
